...
public class Sprite {
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite grass = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.grass, 16, 16);
    public static Sprite brick = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.brick, 16, 16);
    public static Sprite wall = new Sprite(DEFAULT_SIZE, 14, 14, SpriteSheet.wall, 16, 16);
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite player_up = new Sprite(DEFAULT_SIZE, 3, 3, SpriteSheet.player, 12, 16);
    public static Sprite player_down = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.player, 12, 15);
    public static Sprite player_left = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.player, 10, 15);
    public static Sprite player_right = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.player, 10, 16);

    public static Sprite player_up_1 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.player, 12, 16);
    public static Sprite player_up_2 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.player, 12, 15);

    public static Sprite player_down_1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.player, 12, 15);
    public static Sprite player_down_2 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.player, 12, 16);

    public static Sprite player_left_1 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.player, 11, 16);
    public static Sprite player_left_2 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.player, 12, 16);

    public static Sprite player_right_1 = new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.player, 11, 16);
    public static Sprite player_right_2 = new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.player, 12, 16);
    ...
    public static Sprite ghost_dead = new Sprite(DEFAULT_SIZE, 7, 8, SpriteSheet.tiles, 16, 16);
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite powerup_bombs = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.powerBomb, 16, 16);
    public static Sprite powerup_flames = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.powerFlame, 16, 16);
    public static Sprite powerup_speed = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.powerSpeed, 16, 16);
